...
the skills built across this path map to job roles, what to add next,
and how to present Excel work as evidence of analytical capability.
...
The jump from Level 3 to Level 4 is precisely the jump from "I can
build a great model" to "I can be trusted to design the reporting
system a whole team depends on" — governance, architecture, and
integration are what that trust is built on.
...
Each Level's capstone project (Level 2's dashboard, Level 3's
scenario-analysis model, Level 4's capstone in Module 10) is portfolio
material as-is:

1. Take a screenshot or short screen recording of the finished
   dashboard/model.
2. Write two or three sentences: what business question it answers,
   what decision it enables, and one number quantifying its value (as
   in Section 2's `$4,320`/year example).
3. Host these on a simple portfolio page or LinkedIn "Featured"
   section — a hiring manager for an analytics role wants to see a
   finished artifact and its impact, not a list of function names you
   know.
...
- **Modeling**: build an NPV/scenario model live (Level 3 Module 07 and
  10).
- **Data cleaning**: normalize messy input with Power Query (Level 3
  Module 02).
- **Communication**: explain a dashboard's design choices out loud
  (Level 3 Module 08, this level's Module 07).
- **Systems thinking**: explain how you'd stop five people maintaining
  five copies of the same number (this level's Module 08).
